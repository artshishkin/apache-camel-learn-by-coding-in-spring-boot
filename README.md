...
## App # 5 - Build a SOAP Camel Route - SOAP -> Spring-WS -> DB -> MAIL

-  [SOAP Country WebService](http://webservices.oorsprong.org/websamples.countryinfo/CountryInfoService.wso)
